...
\begin{enumerate}
\item Show that the first definition for $\Omega^1_{X/S}$ and the universal derivation $d: \OO_X \rightarrow \Omega^1_{X/S}$ for affine $X, S$ glues to define $\Omega^1_{X/S}$ on non-affines, and show that this definition satisfies the universal property.
\item Vakil 21.2 K, T
\item Vakil 21.3.D
\item Vakil 21.4.B, C
\item Vakil 21.4.D
